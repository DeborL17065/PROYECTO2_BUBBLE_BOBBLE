...
void JUEGO(void) {
  ...
  //*******************************  ATRAPA BURBUJA *************************************
  if ((   (((x1) <= (x40 + 18)) && A30 == 1 && x30 == 330) ||   (((x1) <= (x30 + 18)) && A30 == 0 && x40 == 330)   ) && y == y30 && PBUB == 1 && BBENZO == BENZO_BURBUJA ) {
    BBENZO = PUNTAJE;
  ...
  if ((   (((x1) <= (x41 + 18)) && A31 == 1 && x31 == 330) ||   (((x1) <= (x31 + 18)) && A31 == 0 && x41 == 330)   ) && y == y31 && PBUB == 1  && BBENZO1 == BENZO_BURBUJA ) {
    BBENZO1 = PUNTAJE;
    PUNTAJE1 = PUNTAJE1 + 100;
    RBEN1 = 1;
    XBEN1 = 18;
  ...
  if ((   (((x1) <= (x42 + 18)) && A32 == 1 && x32 == 330) ||   (((x1) <= (x32 + 18)) && A32 == 0 && x42 == 330)   ) && y == y32 && PBUB == 1 && BBENZO2 == BENZO_BURBUJA ) {
    BBENZO2 = PUNTAJE;
    PUNTAJE1 = PUNTAJE1 + 100;
    RBEN2 = 1;
    XBEN2 = 18;
  ...
  //*************************
  if ((   (((x1 + 18) >= (x42)) && A32 == 1 && x32 == 330) ||   (((x1 + 18) >= (x32)) && A32 == 0 && x42 == 330)   ) && y == y32 && PBUB == 0 && BBENZO == BENZO_BURBUJA ) {
    BBENZO = PUNTAJE;
    PUNTAJE1 = PUNTAJE1 + 100;
    RBEN = 1;
    XBEN = 18;
  ...
  if ((   (((x1 + 18) >= (x41)) && A31 == 1 && x31 == 330) ||   (((x1 + 18) >= (x31)) && A31 == 0 && x41 == 330)   ) && y == y31 && PBUB == 0  && BBENZO1 == BENZO_BURBUJA ) {
    BBENZO1 = PUNTAJE;
    PUNTAJE1 = PUNTAJE1 + 100;
    RBEN1 = 1;
    XBEN1 = 18;
  ...
  if ((   (((x1 + 18) >= (x42)) && A32 == 1 && x32 == 330) ||   (((x1 + 18) >= (x32)) && A32 == 0 && x42 == 330)   ) && y == y32 && PBUB == 0 && BBENZO2 == BENZO_BURBUJA ) {
    BBENZO2 = PUNTAJE;
    PUNTAJE1 = PUNTAJE1 + 100;
    RBEN2 = 1;
    XBEN2 = 18;
  ...
  //**********************************************************************************************
  //************************ ATRAPAR A BENZO ********************************
  if (   (   (((XBO - 18) <= (x40 + 15)) && A30 == 1 && x30 == 330) ||   (((XBO - 18) <= (x30 + 15)) && A30 == 0 && x40 == 330)   ) && YBO == y30 && PBOB == 1  )  {
    BBENZO = BENZO_BURBUJA;
    RBEN = 1;
    XBEN = 18;
    U1 = 3;
  }
  if ( (   (((XBO - 18) <= (x41 + 15)) && A31 == 1 && x31 == 330) ||   (((XBO - 18) <= (x31 + 15)) && A31 == 0 && x41 == 330)   ) && YBO == y31 && PBOB == 1  ) {
    BBENZO1 = BENZO_BURBUJA;
    RBEN1 = 1;
    XBEN1 = 18;
    U1 = 3;
  }
  if ( (   (((XBO - 18) <= (x42 + 15)) && A32 == 1 && x32 == 330) ||   (((XBO - 18) <= (x32 + 15)) && A32 == 0 && x42 == 330)   ) && YBO == y32 && PBOB == 1  ) {
    BBENZO2 = BENZO_BURBUJA;
    RBEN2 = 1;
    XBEN2 = 18;
    U1 = 3;
  }
  if ( (   (((XBO + 36) >= (x40)) && A30 == 1 && x30 == 330) ||   (((XBO + 36) >= (x30)) && A30 == 0 && x40 == 330)   ) && YBO == y30 && PBOB == 0  )  {
    BBENZO = BENZO_BURBUJA;
    RBEN = 1;
    XBEN = 18;
    U1 = 0;
  }
  if ((   (((XBO + 36) >= (x41)) && A31 == 1 && x31 == 330) ||   (((XBO + 36) >= (x31)) && A31 == 0 && x41 == 330)   ) && YBO == y31 && PBOB == 0  ) {
    BBENZO1 = BENZO_BURBUJA;
    RBEN1 = 1;
    XBEN1 = 18;
    U1 = 0;
  }
  if ((   (((XBO + 36) >= (x42)) && A32 == 1 && x32 == 330) ||   (((XBO + 36) >= (x32)) && A32 == 0 && x42 == 330)   ) && YBO == y32 && PBOB == 0   ) {
    BBENZO2 = BENZO_BURBUJA;
    RBEN2 = 1;
    XBEN2 = 18;
    U1 = 0;
  ...
  //********************************************************************
  if ((   (((x2) <= (x40 + 18)) && A30 == 1 && x30 == 330) ||   (((x2) <= (x30 + 18)) && A30 == 0 && x40 == 330)   ) && y2 == y30 && PBOB == 1 && BBENZO == BENZO_BURBUJA ) {
    BBENZO = PUNTAJE;
  ...
  if ((   (((x2) <= (x41 + 18)) && A31 == 1 && x31 == 330) ||   (((x2) <= (x31 + 18)) && A31 == 0 && x41 == 330)   ) && y2 == y31 && PBOB == 1 && BBENZO1 == BENZO_BURBUJA ) {
    BBENZO1 = PUNTAJE;
    PUNTAJE2 = PUNTAJE2 + 100;
    RBEN1 = 1;
    XBEN1 = 18;
  ...
  if ((   (((x2) <= (x42 + 18)) && A32 == 1 && x32 == 330) ||   (((x2) <= (x32 + 18)) && A32 == 0 && x42 == 330)   ) && y2 == y32 && PBOB == 1 && BBENZO2 == BENZO_BURBUJA ) {
    BBENZO2 = PUNTAJE;
    PUNTAJE2 = PUNTAJE2 + 100;
    RBEN2 = 1;
    XBEN2 = 18;
  ...
  //*********************************************
  if ((   (((x2 + 18) >= (x42)) && A32 == 1 && x32 == 330) ||   (((x2 + 18) >= (x32)) && A32 == 0 && x42 == 330)   ) && y2 == y32 && PBOB == 0 && BBENZO == BENZO_BURBUJA ) {
    BBENZO = PUNTAJE;
    PUNTAJE2 = PUNTAJE2 + 100;
    RBEN = 1;
    XBEN = 18;
  ...
  if ((   (((x2 + 18) >= (x41)) && A31 == 1 && x31 == 330) ||   (((x2 + 18) >= (x31)) && A31 == 0 && x41 == 330)   ) && y2 == y31 && PBOB == 0 && BBENZO1 == BENZO_BURBUJA ) {
    BBENZO1 = PUNTAJE;
    PUNTAJE2 = PUNTAJE2 + 100;
    RBEN1 = 1;
    XBEN1 = 18;
  ...
  if ((   (((x2 + 18) >= (x42)) && A32 == 1 && x32 == 330) ||   (((x2 + 18) >= (x32)) && A32 == 0 && x42 == 330)   ) && y2 == y32 && PBOB == 0 && BBENZO2 == BENZO_BURBUJA ) {
    BBENZO2 = PUNTAJE;
    PUNTAJE2 = PUNTAJE2 + 100;
    RBEN2 = 1;
    XBEN2 = 18;
  ...
  if ( ( (x1 + 18)  >= x23 ) && x1 < 245  && y == y23 && PBUB == 0) {
    BPERA = PUNTAJE;
    PUNTAJE1 = PUNTAJE1 + 50;
  }
  //*********************** BOB *****************************
  if ( ( x2  <= (x20 + 18) )  && y2 == y20 && PBOB == 1) {
    BMANZANA = PUNTAJE;
    PUNTAJE2 = PUNTAJE2 + 50;
  }
  if (( x2  <= (x21 + 18) ) && y2 == y21 && PBOB == 1 ) {
    BCHERRY = PUNTAJE;
    PUNTAJE2 = PUNTAJE2 + 50;
  }
  if ( ( x2  <= (x22 + 18) ) && y2 == y22 && PBOB == 1 ) {
    BPINA = PUNTAJE;
    PUNTAJE2 = PUNTAJE2 + 50;
  }
  if ( ( x2  <= (x23 + 18) ) && x2 > 190  && y2 == y23 && PBOB == 1) {
    BPERA = PUNTAJE;
    PUNTAJE2 = PUNTAJE2 + 50;
  }
  //******************
  if ( ( (x2 + 18)  >= x20 ) && x2 < 170 && y2 == y20 && PBOB == 0) {
    BMANZANA = PUNTAJE;
    PUNTAJE2 = PUNTAJE2 + 50;
  }
  if (( (x2 + 18)  >= x21 ) &&  x2 < 180 && y2 == y21 && PBOB == 0 ) {
    BCHERRY = PUNTAJE;
    PUNTAJE2 = PUNTAJE2 + 50;
  }
  if ( ( (x2 + 18)  >= x22 ) && x2 < 90  && y2 == y22 && PBOB == 0) {
    BPINA = PUNTAJE;
    PUNTAJE2 = PUNTAJE2 + 50;
  }
